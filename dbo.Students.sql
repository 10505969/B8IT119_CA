...
CREATE TRIGGER StudentUpdate
	...
	AS
	BEGIN
		INSERT INTO StudentLog (ChangeDate, Change, FirstName, LastName, EmailNew, EmailOld, PhoneNew, PhoneOld, AddressLine1New, AddressLine1Old, AddressLine2New, AddressLine2Old, CityNew, CityOld, CountyNew, CountyOld, LevelNew, LevelOld, Course, StudentNo)
		SELECT GETDATE(), 'Updated', i.FirstName, i.LastName, i.Email, d.Email, i.Phone, d.Phone, i.AddressLine1, d.AddressLine1, i.AddressLine2, d.AddressLine2, i.City, d.City, i.County, d.County, i.Level, d.Level, i.Course, i.StudentNo
...
CREATE TRIGGER StudentDelete
	...
	BEGIN
		...
		SELECT GETDATE(), 'Deleted', d.FirstName, d.LastName, d.Email, d.Phone, d.AddressLine1, d.AddressLine2, d.City, d.County, d.Level, d.Course, d.StudentNo
